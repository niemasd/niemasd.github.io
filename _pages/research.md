...
<center><a href="#books-games">Books/Games</a> – <a href="#papers-articles">Papers/Articles</a> – <a href="#conference-presentations">Conference Presentations</a> – <a href="#preprints-reports">Preprints/Reports</a></center>
...
<h2 id="books-games">Books/Games</h2>
<ol reversed>{% for post in site.publications reversed %}
  {% if post.pubtype == 'book_game' %}
